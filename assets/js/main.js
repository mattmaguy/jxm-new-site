...
/* ════════════════════════════════════════
   ...
   Reads + writes localStorage under 'jxm-theme'.
   Body.dark class is what flips the theme;
   the early <body> script applies it pre-render.
════════════════════════════════════════ */
(function(){
  document.addEventListener('DOMContentLoaded', function(){
    ...
    btn.addEventListener('click', function(){
      ...
      var mode = body.classList.contains('dark') ? 'dark' : 'light';
      try { localStorage.setItem('jxm-theme', mode); } catch(e){}
      syncBtn();
    });
  });
})();
